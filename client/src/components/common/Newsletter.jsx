...
<div className="bg-gray-900 py-16 sm:py-24 lg:py-32">
  <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
    <div className="max-w-xl text-3xl font-bold tracking-tight text-white sm:text-4xl lg:col-span-7">
      <h2 className="inline sm:block lg:inline xl:block">Quer notícias Diárias?</h2>
      <p className="inline sm:block lg:inline xl:block">Subscreva-se na nossa newsletter.</p>
    </div>
    <form className="w-full max-w-md lg:col-span-5 lg:pt-2">
      ...
      <p className="mt-4 text-sm leading-6 text-gray-300">Nós nos preocupamos com a sua informação. Leia os nossos <a href="/termoscondicoes" className="font-semibold text-white hover:text-indigo-50">termos e condições</a>.</p>
    </form>
  </div>
</div>
</div>
