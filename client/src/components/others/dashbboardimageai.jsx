...
<div className="bg-gray-900 min-h-screen">
      ...
      <div className="max-w-[800px] mx-auto text-center flex flex-col justify-center">
        ...
        <div className="flex flex-col justify-center items-center h-screen bg-gray-900 text-black">
        <input 
        type="text" 
        value={prompt} 
        onChange={(e) => setPrompt(e.target.value)} 
        placeholder="Digite o que quer"
      />
      <button onClick={fetchOutputFromBackend}>Executar Replicate</button>
      {output && (
        <div>
