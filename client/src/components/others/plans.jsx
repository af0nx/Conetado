...
<div class="bg-gray-900 py-24 sm:py-32">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-4xl text-center">
      <p class="mt-2 text-4xl font-bold tracking-tight text-cyan-50 sm:text-5xl">Preços para todos!</p>
    </div>
    <p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-cyan-50">Desbloqueie todo o potencial com nossos planos premium de IA.</p>

    <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
      <div class="rounded-3xl p-8 ring-1 xl:p-10 ring-yellow-400">
        <h3 id="tier-freelancer" class="text-lg font-semibold leading-8 text-orange-600">Essencial</h3>
        <p class="mt-4 text-sm leading-6 text-green-600">The essentials to provide your best work for clients.</p>
        <p class="mt-6 flex items-baseline gap-x-1">
          <span class="text-4xl font-bold tracking-tight text-pink-900">17,99€</span>
          <span class="text-sm font-semibold leading-6 text-purple-600">/Permanentemente</span>
        </p>
      ...
      <div class="rounded-3xl p-8 ring-1 xl:p-10 ring-gray-700">
        <h3 id="tier-startup" class="text-lg font-semibold leading-8 text-gray-50">Pro</h3>
        <p class="mt-4 text-sm leading-6 text-cyan-600">A plan that scales with your rapidly growing business.</p>
        <p class="mt-6 flex items-baseline gap-x-1">
          <span class="text-4xl font-bold tracking-tight text-yellow-700">59,99€</span>
          <span class="text-sm font-semibold leading-6 text-teal-600">/Permanentemente</span>
        </p>
      ...
      <div class="rounded-3xl p-8 ring-1 xl:p-10 bg-gray-900 ring-gray-900">
        <h3 id="tier-enterprise" class="text-lg font-semibold leading-8 text-white">Empresas</h3>
