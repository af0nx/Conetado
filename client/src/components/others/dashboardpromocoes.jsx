            ...
            <div className="py-16">
              <div className="mx-auto px-6 max-w-6xl text-gray-500">
                <div className="text-center">
                  ...
                  Conheça as nossas promoções incríveis que ajudam a impulsionar o seu sucesso. </p>
                ...
                <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <div className="relative">
                      ...
                      <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                        <p className="text-gray-700 dark:text-gray-300">
                          O melhor website para quem procura varios gerador de IA! <br /> <br /> Na compra da versão premium receba 50% de desconto
                        </p>
                      </div>
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                        <p className="text-gray-700 dark:text-gray-300">
                          O melhor website para quem quer comprar o melhor bot de chat! <br /> <br /> 20% de desconto na compra
                        </p>
                      </div>
                  ...
                  <div className="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                    ...
                    <div className="relative">
                      ...
                      <div className="mt-6 pb-6 rounded-b-[--card-border-radius]">
                        <p className="text-gray-700 dark:text-gray-300">
                          Nunca foi tao fácil remover o background de imagens! <br /> <br /> 10€ grátis numa compra de 20€
                        </p>
                      </div>
                      <div className="flex gap-3 -mb-8 py-4 border-t border-gray-200 dark:border-gray-800">
                        <a
